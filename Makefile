...
# Targets
all: ex-01_dyn ex-heat_equation ex-heat_equation_2D not_dyn_h_e_2D ex-02_dyn
...
clean:
	rm -f *.o *.out.* ex-01_dyn ex-heat_equation ex-heat_equation_2D not_dyn_h_e_2D ex-02_dyn
