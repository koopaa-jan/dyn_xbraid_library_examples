...
int main (int argc, char *argv[])
{
   ...
   while (arg_index < argc)
   {
      ...
      else if( strcmp(argv[arg_index], "-interval_len") == 0 ){
	      arg_index++;
	      interval_len = strtod(argv[arg_index++], &endptr);
      }
      else if( strcmp(argv[arg_index], "-info_str") == 0 ){
	      arg_index++;
	      info_str = argv[arg_index++];
      }
      else if( strcmp(argv[arg_index], "-info_num") == 0 ){
	      arg_index++;
	      info_num = argv[arg_index++];
      }
      else if( strcmp(argv[arg_index], "-file_num") == 0 ){
    	      arg_index++;
	      file_num_t = atoi(argv[arg_index++]);  
      }
      else
      {
